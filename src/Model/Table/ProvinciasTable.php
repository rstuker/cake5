 ...
 * Provincias Model
 *
 * @property \App\Model\Table\ZonasTable&\Cake\ORM\Association\HasMany $Zonas
 *
...
class ProvinciasTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        $validator
            ...
            ->add('Provincia', 'unique', ['rule' => 'validateUnique', 'provider' => 'table']);

        $validator
            ->date('fechalog')
            ->notEmptyDate('fechalog');
    ...
    {
        $rules->add($rules->isUnique(['Provincia']), ['errorField' => 'Provincia']);
